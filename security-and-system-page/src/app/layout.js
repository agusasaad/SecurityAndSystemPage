...
export const metadata = {
  ...
  description:
    'Creamos soluciones digitales personalizadas: desarrollo web, apps móviles y servicios en la nube para transformar tu negocio con nuestra tecnología y consultoría IT.',
  keywords:
